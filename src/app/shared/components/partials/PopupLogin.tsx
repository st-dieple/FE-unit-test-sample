...
const PopUpLogin = ({isShow} : IPopUpLoginProps) => {
  const {
    register,
    getValues,
    handleSubmit,
  ...
  return (
    <div className={`popup-login ${isShow ? 'popup-login-active' : ''}`}>
      <form className="popup-login-form" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-btn">
          <Button classBtn="btn btn-primary popup-login-btn" text="Sign in" isLoading={isLoading} />
        </div>
